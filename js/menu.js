...
const menuData = [
    {
      ...
      desc: "厳選された**沖縄県産豚肉**を丁寧に煮込んだ**軟骨ソーキ**と**三枚肉**、かまぼこを贅沢にのせた、当店の**イチオシ沖縄そば**です。じっくりと時間をかけて仕上げた透明感のあるスープは、あっさりしながらも深いコクがあり、**中城村**の風土が育んだ伝統の味をぜひご賞味ください。",
      price: "準備中",
      category: "soba",
      badge: "NEW"
    },
    {
      ...
      desc: "**とろけるような柔らかさ**に煮込んだ**自家製軟骨ソーキ**が絶妙な一杯です。特製の**あっさりスープ**と絡み合い、口の中でとろける食感が特徴。手間暇かけて下処理し、臭みを徹底的に取り除いた軟骨ソーキは、当店ならではの**心温まる味わい**をお楽しみいただけます。",
      price: "準備中",
      category: "soba"
    },
    {
